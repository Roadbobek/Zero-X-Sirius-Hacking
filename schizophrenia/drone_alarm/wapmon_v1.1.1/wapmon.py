# WAP Monitor - wapmon
# By Roadbobek, v1.1.1 (Linux nmcli parsing fix)
    ...
    if sys.platform == "win32":
        ...
        if sys.platform == "darwin":
            ...
            try:
                ...
                # FIX: Use string manipulation based on fixed BSSID length (23 chars escaped)
                BSSID_ESCAPED_LENGTH = 23
                ...
                for line in lines:
                    ...
                    # BSSID is exactly the first 23 characters (XX\:XX\:XX\:XX\:XX\:XX)
                    ...
                    # NOTE: We skip the 23rd character (which should be the ':')
